...
This is a summary of the data in file tidydataset.txt

***** VARIABLES ***** 

 [1] "subject"  - Test subject ID                                           
 [2] "activity" - Activity that was performed by subject and measured. Each activity was labeled the following:
